"""
BlueSky followers functionality.
"""
...
class BlueSkyFollowers:
    ...
    def get_followers_raw(self, username: str, limit: int = 100) -> List[Any]:
        ...
        Returns:
            List of follower profile objects
        """
        try:
            username = validate_username(username)
    ...
    def get_followers_data(self, username: str, limit: int = 100) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary with follower data and metadata
        """
        username = validate_username(username)
        ...
        return {
            ...
            "metadata": {
                ...
                "retrieval_date": format_date(None)  # Current date would go here
            }
        }
    ...
    def display_followers_table(self, username: str, limit: int = 100, 
        ...
        """
        Display followers in a Rich table format (legacy CLI functionality).
